        ...
        for studorg in organeList  :
            if studorg in orga[project]:
                ...
                dico={
                    ...
                    'factors' : "",
                    'signatures' : "",
                    'title' : projectName+" - Toxicogenomics signatures of "+tissue_name+" after exposure to "+project+" in the rat",
                ...
                study_worksheet.write('C'+str(title_line + study_id), projectName+" - Toxicogenomics signatures of "+tissue_name+" after exposure to "+project+" in the rat")
                ...
                for cond in orga[project][studorg] :
                    ...
                    dico={
                        ...
                        'title' : projectName+" - Toxicogenomics signatures of "+tissue_name+" after exposure to "+project+" ("+doses+" "+dose_unit+", "+exposure+" "+exposure_unit+") in the rat",
                    ...
                    asssay_worksheet.write('C'+str(title_line + assay_id), projectName+" - Toxicogenomics signatures of "+tissue_name+" after exposure to "+project+" ("+doses+" "+dose_unit+", "+exposure+" "+exposure_unit+") in the rat")
                    ...
                    signature_worksheet.write('D'+str(title_line + signature_id), "Open TG-GATEs  - Toxicogenomics signatures of "+tissue_name+" after exposure to "+project+" ("+doses+" "+dose_unit+", "+exposure+" "+exposure_unit+") in the rat")
        ...
        for studorg in organeList  :
            if studorg in orga[project]:
                ...
                dico={
                    ...
                    'factors' : "",
                    'signatures' : "",
                    'title' : "Open TG-GATEs - Toxicogenomics signatures of "+tissue_name+" after exposure to "+project+" in the rat",
                    'description' : study_description,
                ...
                study_worksheet.write('A'+str(title_line + study_id), 'St'+str(study_id))
                study_worksheet.write('B'+str(title_line + study_id), 'PR'+str(project_id))
                study_worksheet.write('C'+str(title_line + study_id), "Open TG-GATEs - Toxicogenomics signatures of "+tissue_name+" after exposure to "+project+" in the rat")
                study_worksheet.write('D'+str(title_line + study_id), study_description)
                ...
                for cond in orga[project][studorg] :
                    ...
                    dico={
                        ...
                        'signatures' : "",
                        'projects' : studies['St'+str(study_id)]['projects'],
                        'title' : "Open TG-GATEs - Toxicogenomics signatures of "+tissue_name+" after exposure to "+project+" ("+str(doses)+" "+dose_unit+", "+str(exposure)+" "+exposure_unit+") in the rat",
                        'organism' : 'Rattus norvegicus',
                        'experimental_type' : 'in vivo',
                        'developmental_stage' : 'Adulthood',
                        'generation' : 'f0',
                    ...
                    asssay_worksheet.write('A'+str(title_line + assay_id), 'As'+str(assay_id))
                    asssay_worksheet.write('B'+str(title_line + assay_id), 'St'+str(study_id))
                    asssay_worksheet.write('C'+str(title_line + assay_id), "Open TG-GATEs  - Toxicogenomics signatures of "+tissue_name+" after exposure to "+project+" ("+str(doses)+" "+dose_unit+", "+str(exposure)+" "+exposure_unit+") in the rat")
                    asssay_worksheet.write('D'+str(title_line + assay_id), 'NCBITaxon:10116')
                    asssay_worksheet.write('E'+str(title_line + assay_id), 'Adulthood')
                    asssay_worksheet.write('F'+str(title_line + assay_id), "f0")
                    asssay_worksheet.write('G'+str(title_line + assay_id), "Male")
                    ...
                    signature_worksheet.write('B'+str(title_line + signature_id), 'St'+str(study_id))
                    signature_worksheet.write('C'+str(title_line + signature_id), 'As'+str(assay_id))
                    signature_worksheet.write('D'+str(title_line + signature_id), "Open TG-GATEs - Toxicogenomics signatures of "+tissue_name+" after exposure to "+project+" ("+str(doses)+" "+dose_unit+", "+str(exposure)+" "+exposure_unit+") in the rat")
                    signature_worksheet.write('E'+str(title_line + signature_id), 'Genomic')
                    signature_worksheet.write('F'+str(title_line + signature_id), 'Rattus norvegicus')
                    signature_worksheet.write('G'+str(title_line + signature_id), "Adulthood")
                    signature_worksheet.write('H'+str(title_line + signature_id), "f0")
...
def insertHumanTG():
    ...
    for project in orga :
        ...
        Dataset_status = "public"
        Dataset_ID = 'TSP' + str(get_Index('project'))
        Dataset_title = "Open TG-GATEs - Toxicogenomics signatures after exposure to "+project+" in the human"
        ...
        for studorg in organeList  :
            if studorg in orga[project]:
                ...
                dico={
                    ...
                    'factors' : "",
                    'signatures' : "",
                    'title' : "Open TG-GATEs - Toxicogenomics signatures of "+tissue_name+" after exposure to "+project+" in the human",
                    'description' : study_description,
                ...
                study_worksheet.write('A'+str(title_line + study_id), 'St'+str(study_id))
                study_worksheet.write('B'+str(title_line + study_id), 'PR'+str(project_id))
                study_worksheet.write('C'+str(title_line + study_id), "Open TG-GATEs - Toxicogenomics signatures of "+tissue_name+" after exposure to "+project+" in the human")
                study_worksheet.write('D'+str(title_line + study_id), study_description)
                ...
                for cond in orga[project][studorg] :
                    ...
                    dico={
                        ...
                        'signatures' : "",
                        'projects' : studies['St'+str(study_id)]['projects'],
                        'title' : "Open TG-GATEs - Toxicogenomics signatures of "+tissue_name+" after exposure to "+project+" ("+doses+" "+dose_unit+", "+exposure+" "+exposure_unit+") in the human",
                    ...
                    asssay_worksheet.write('A'+str(title_line + assay_id), 'As'+str(assay_id))
                    asssay_worksheet.write('B'+str(title_line + assay_id), 'St'+str(study_id))
                    asssay_worksheet.write('C'+str(title_line + assay_id), "Open TG-GATEs  - Toxicogenomics signatures of "+tissue_name+" after exposure to "+project+" ("+doses+" "+dose_unit+", "+exposure+" "+exposure_unit+") in the human")
                    ...
                    signature_worksheet.write('B'+str(title_line + signature_id), 'St'+str(study_id))
                    signature_worksheet.write('C'+str(title_line + signature_id), 'As'+str(assay_id))
                    signature_worksheet.write('D'+str(title_line + signature_id), "Open TG-GATEs - Toxicogenomics signatures of "+tissue_name+" after exposure to "+project+" ("+doses+" "+dose_unit+", "+exposure+" "+exposure_unit+") in the human")
                    signature_worksheet.write('E'+str(title_line + signature_id), 'Genomic')
...
def otherHuman():
    ...
    for projectName in dicoGSE :
        ...
        for project in orga :
            ...
            Dataset_status = "public"
            Dataset_ID = 'TSP' + str(get_Index('project'))
            Dataset_title = "Toxicogenomics signatures after exposure to "+project+" in the human"
            ...
            for studorg in organeList  :
                if studorg in orga[project]:
                    ...
                    dico={
                        ...
                        'factors' : "",
                        'signatures' : "",
                        'title' : "Toxicogenomics signatures of "+tissue_name+" "+cell_name+" after exposure to "+project+" in the human",
                        'description' : study_description,
                    ...
                    study_worksheet.write('A'+str(title_line + study_id), 'St'+str(study_id))
                    study_worksheet.write('B'+str(title_line + study_id), 'PR'+str(project_id))
                    study_worksheet.write('C'+str(title_line + study_id), "Toxicogenomics signatures of "+tissue_name+" "+cell_name+" after exposure to "+project+" in the human")
                    study_worksheet.write('D'+str(title_line + study_id), study_description)
                    ...
                    for cond in orga[project][studorg] :
                        ...
                        dico={
                            ...
                            'signatures' : "",
                            'projects' : studies['St'+str(study_id)]['projects'],
                            'title' : "Toxicogenomics signatures of "+tissue_name+" "+cell_name+" after exposure to "+project+" ("+str(doses)+" "+str(dose_unit)+", "+str(exposure)+" "+str(exposure_unit)+") in the human",
                            'organism' : 'Homo sapiens',
                        ...
                        asssay_worksheet.write('A'+str(title_line + assay_id), 'As'+str(assay_id))
                        asssay_worksheet.write('B'+str(title_line + assay_id), 'St'+str(study_id))
                        asssay_worksheet.write('C'+str(title_line + assay_id), "Toxicogenomics signatures of "+tissue_name+" "+cell_name+" after exposure to "+project+" ("+str(doses)+" "+str(dose_unit)+", "+str(exposure)+" "+str(exposure_unit)+") in the human")
                        asssay_worksheet.write('D'+str(title_line + assay_id), 'NCBITaxon:9606')
                        ...
                        signature_worksheet.write('B'+str(title_line + signature_id), 'St'+str(study_id))
                        signature_worksheet.write('C'+str(title_line + signature_id), 'As'+str(assay_id))
                        signature_worksheet.write('D'+str(title_line + signature_id), "Toxicogenomics signatures of "+tissue_name+" "+cell_name+" after exposure to "+project+" ("+str(doses)+" "+str(dose_unit)+", "+str(exposure)+" "+str(exposure_unit)+") in the human")
                        signature_worksheet.write('E'+str(title_line + signature_id), 'Genomic')
                        signature_worksheet.write('F'+str(title_line + signature_id), 'Homo sapiens')
